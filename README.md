...
- **אירועי העירייה — חיים** — כל לוח האירועים העירוני מוטמע במפה: משיכה ישירה מ-API העירייה בדפדפן (אירוע חדש מופיע תוך שניות), קיבוץ לפי מקום עם תג ספירה, מדורי היום/מחר/השבוע, תמונות וקישורי הרשמה. קובץ גיבוי מתעדכן ב-Action כל 3 שעות
