...
const SYSTEM = `אתה מנוע הכוונות של "רמת גן · המפה החיה" — מפת עיר שמציגה עסקים ואירועים.
...
"מה קורה הערב בעיר?" → {"kinds":["event"],"evCats":[],"keywords":[],"when":"today","openNow":false,"reply":"אלה האירועים שקורים היום ברמת גן"}
